...
function Connect-ToMicrosoftGraph {
    ...
    if (-not $mgModule) {
        ...
        Write-Host ""
        Write-Host "  Or for all users (requires admin):" -ForegroundColor Gray
...
"@
    ...
    <hr>
    <p style="font-size: 12px; color: #666;">Generated by License Expiration Checker | Soulitek.co.il | https://soulitek.co.il</p>
</body>
</html>
"@
...
"@
    ...
    <div class="footer">
        ...
        <p>https://soulitek.co.il | (C) 2025 Soulitek - All Rights Reserved</p>
    </div>
</body>
</html>
"@
...
function Show-MainMenu {
    ...
    Write-Host "      https://soulitek.co.il" -ForegroundColor Green
    Write-Host ""
...
function Show-ExitMessage {
    ...
    Write-Host "      LICENSE EXPIRATION CHECKER" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "============================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "       Coded by: Soulitek.co.il" -ForegroundColor Green
    ...
    Write-Host "============================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "   Need help with Microsoft 365 license management?" -ForegroundColor White
