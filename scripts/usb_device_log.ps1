...
"@
    ...
    <div class="footer">
        ...
        <div style="margin-top: 8px;">
            Coded by <strong>Soulitek.co.il</strong> | https://soulitek.co.il<br>
            (C) 2025 Soulitek - All Rights Reserved
        </div>
...
function Show-ExitMessage {
    ...
    Write-Host "        USB DEVICE LOG - FORENSIC TOOL" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "============================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "       Coded by: Soulitek.co.il" -ForegroundColor Green
    ...
    Write-Host "============================================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "   Need IT forensics or security services?" -ForegroundColor White
